Feature: Banking
  ...
  I want to use a ATM Trasanction
    ...
    @testEntityKey=SUPPORT-TC-58903
    @testEntityKey=SUPPORT-TC-58904
    @testEntityKey=SUPPORT-TC-58905
    ...
    @requirementKey=MAC-RQ-183
    @testEntityKey=SUPPORT-TC-58906
    ...
    @requirementKey=MAC-RQ-183
    @testEntityKey=SUPPORT-TC-58907
